...
* Pantalla de **Inicio
  ![alt text](img/pantalla_inicio.png)
* Formulario para **Registrar platillo**

  ![](assets/20260820_205754_image.png)
* Pantalla de **Realizar pedido** con mapa

  ![](assets/20260820_205805_image.png)
* Página **Acerca**
  ![alt text](image.png)
* Página **Contacto**
  ![alt text](img/contacto.png)
*

# Base de datos

La aplicación utiliza **Firebase Firestore**, una base de datos **NoSQL en la nube**, para almacenar y sincronizar la información en tiempo real. Además, se utiliza **Firebase Storage** para guardar las imágenes de los platillos.
